  ...
  return (
    <Card className="shadow-lg">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>
          {state === 'confirming' && 'Are you sure you want to decline this invitation?'}
        ...
        <div className="flex flex-col items-center justify-center py-8">
          {state === 'confirming' && (
            <>
              ...
              <p className="text-sm text-muted-foreground text-center mb-6">
                You are about to decline this organization invitation. This action cannot be undone.
                You will need to request a new invitation if you change your mind.
              </p>
          ...
          {state === 'success' && (
            <>
              ...
              <p className="text-sm text-muted-foreground text-center mb-6">
                You have successfully declined the invitation. You can close this page now.
              </p>
