 ...
 * Reads token from URL search params, validates, and processes acceptance.
 */
...
function AcceptInvitationContent() {
  ...
  const [orgData, setOrgData] = useState<AcceptedInvitationResponse | null>(null);
          ...
          {state === 'success' && orgData && (
            <>
              ...
              <p className="text-sm text-muted-foreground text-center mb-4">
                You have been added to <strong>{orgData.organization.name}</strong> as a{' '}
